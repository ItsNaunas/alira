    ...
    <>
      ...
      >
        <div className="flex justify-between items-center z-20 w-full">
          <span className="text-alira-gold font-serif font-normal tracking-wider text-xl">
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className={cn(
                "fixed h-full w-full inset-0 bg-alira-primary z-[100] flex flex-col justify-between p-10",
                className
              )}
            >
              <div
...
export const SidebarLink = ({
  ...
  return (
    <a
      href={link.href}
      className={cn(
        "flex items-center justify-start gap-2 group/sidebar py-2 px-2 rounded-lg hover:bg-alira-primary-light transition-colors",
        className
      )}
      {...props}
    >
