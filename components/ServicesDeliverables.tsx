...
export default function ServicesDeliverables() {
  return (
    <section aria-labelledby="svc-deliverables-heading" className="relative max-w-6xl mx-auto px-6 sm:px-8 py-16 md:py-24">
      ...
      <Reveal delay={250}>
        <p className="mt-4 text-center text-alira-onyx/70 max-w-2xl mx-auto">
      ...
      <ul role="list" className="mt-14 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-14">
        ...
        <Reveal delay={350}>
          <li className="group">
            <span className="block h-[2px] w-12 bg-alira-gold mb-3 transition-all duration-300 group-hover:w-16" />
            <h3 className="text-lg font-semibold text-alira-onyx">Priorities & Measures That Matter</h3>
            <p className="mt-2 text-sm leading-relaxed text-alira-onyx/70">
        ...
        <Reveal delay={450}>
          <li className="group">
            <span className="block h-[2px] w-12 bg-alira-gold mb-3 transition-all duration-300 group-hover:w-16" />
            <h3 className="text-lg font-semibold text-alira-onyx">30-Day Execution Plan</h3>
            <p className="mt-2 text-sm leading-relaxed text-alira-onyx/70">
