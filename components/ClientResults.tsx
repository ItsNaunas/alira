  ...
  return (
    <section className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <Reveal delay={200}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {results.map((category, index) => (
              <div key={index} className="bg-alira-porcelain/30 rounded-2xl p-8 border border-alira-onyx/5">
                <h3 className="text-xl font-bold text-alira-onyx mb-6 text-center">
                  {category.category}
                </h3>
                    ...
                    return (
                      <div key={metricIndex} className="flex items-center space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="text-xl font-bold text-alira-onyx">
                            {metric.value}
                          </div>
        ...
        {/* Key Achievements */}
        <Reveal delay={400}>
          <div className="bg-alira-onyx/5 rounded-2xl p-8 lg:p-12 border border-alira-onyx/10">
            <h3 className="text-2xl font-bold text-alira-onyx mb-8 text-center">
              Key Achievements
            </h3>
        ...
        <Reveal delay={600}>
          <div className="mt-16 text-center">
            <div className="inline-block bg-alira-gold/10 rounded-full px-8 py-4 border border-alira-gold/20">
              <div className="text-2xl font-bold text-alira-onyx mb-2">
        ...
        {/* Testimonial */}
        <Reveal delay={800}>
          <div className="mt-16 bg-white rounded-2xl p-8 border border-alira-onyx/10 shadow-lg">
            <div className="text-center">
              <div className="text-sm tracking-wide uppercase text-alira-gold mb-4 font-medium">
                CLIENT TESTIMONIAL
              </div>
              <blockquote className="text-lg text-alira-onyx/80 italic mb-4 max-w-3xl mx-auto">
