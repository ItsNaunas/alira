...
export default function DesignerPricing() {
  return (
    <div className="relative min-h-full w-full bg-black font-sans text-white antialiased">
      <section className="relative mr-auto ml-auto max-w-7xl pt-16 pr-4 pb-16 pl-4 sm:px-6 sm:py-24 lg:px-8">
        <div className="mb-16 text-center sm:mb-20">
          <h1 className="mb-6 text-4xl leading-tight font-serif font-bold tracking-tight sm:text-5xl lg:text-6xl">
            <span
              className={cn(
                'text-7xl font-normal tracking-tight text-alira-gold',
                serif.className,
              )}
            >
              Choose Your
            ...
            <span
              className={cn(
                'text-8xl font-normal tracking-tight text-white',
                serif.className,
              )}
            >
              Growth Journey
          ...
          <p className="mr-auto ml-auto max-w-3xl text-base text-neutral-400 sm:text-lg">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-8">
          ...
          <article className="relative flex flex-col rounded-3xl border-2 border-[#1E3A8A]/50 bg-gradient-to-br from-[#1E3A8A]/20 to-[#1E40AF]/30 pt-8 pr-8 pb-8 pl-8 transition-all duration-300 hover:border-[#1E3A8A] lg:p-10">
            <div className="mb-8 flex items-start justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-sans font-semibold tracking-wide text-[#1E3A8A]/80 uppercase">
                  Content
                </span>
              </div>
              <span className="rounded-full border border-[#1E3A8A]/30 bg-[#1E3A8A]/10 px-3 py-1 text-xs font-sans font-medium text-[#1E3A8A] uppercase">
                Perfect Start
              </span>
            </div>

            <div className="mb-8">
              <h2 className="mb-3 text-2xl leading-tight font-sans font-medium lg:text-2xl text-white">
                Content & Growth
              </h2>
            ...
            <div className="mb-8">
              <div className="mb-2 flex items-end gap-2">
                <span className="text-4xl font-serif font-bold tracking-tight lg:text-5xl text-white">
                  £500
                </span>
            ...
            <div className="mb-8 flex flex-col gap-3">
              <button className="w-full rounded-lg bg-[#1E3A8A] px-6 py-3 text-sm font-sans font-semibold text-white transition-all duration-200 hover:bg-[#1E3A8A]/90">
                Start Content Strategy
              </button>
              <button className="w-full rounded-lg border-2 border-white/30 px-6 py-3 text-sm font-sans font-medium text-white transition-all duration-200 hover:bg-white/10 hover:border-white/50">
                View Details
              </button>
            </div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-check-circle mt-0.5 h-4 w-4 flex-shrink-0 text-[#1E3A8A]"
                >
          ...
          <article className="relative flex flex-col rounded-3xl border-2 border-[#1E3A8A]/50 bg-gradient-to-br from-[#1E3A8A]/20 to-[#1E40AF]/30 pt-8 pr-8 pb-8 pl-8 transition-all duration-300 hover:border-[#1E3A8A] lg:p-10">
            ...
            <div className="mb-8">
              <div className="mb-2 flex items-end gap-2">
                <span className="text-4xl font-serif font-bold tracking-tight text-white lg:text-5xl">
                  £750
                </span>
                <span className="mb-1 text-white/60">/month</span>
              </div>
          ...
          <article className="relative flex flex-col rounded-3xl border-2 border-alira-gold bg-gradient-to-br from-[#1E3A8A]/20 to-[#1E40AF]/30 pt-8 pr-8 pb-8 pl-8 transition-all duration-300 hover:border-alira-gold lg:col-span-2 lg:p-10">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 transform">
              <div className="rounded-full bg-alira-gold px-4 py-2 text-xs font-bold text-black uppercase">
                Most Popular
              </div>
            </div>
