        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
              ...
              <article className="relative flex flex-col rounded-3xl border-2 border-brand/30 bg-surface shadow-token-sm p-8 transition-all duration-300 hover:border-brand hover:shadow-token-lg lg:p-10">
                <div className="mb-8 flex items-start justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-sans font-semibold uppercase tracking-wide text-brand/80">
                      Content
                    </span>
                  </div>
                  <span className="rounded-full border border-brand/30 bg-brand/10 px-3 py-1 text-xs font-sans font-medium uppercase text-brand">
                    Perfect Start
                  </span>
                </div>

                <div className="mb-8">
                  <h2 className="mb-3 text-2xl font-sans font-medium leading-tight text-text-primary lg:text-2xl">
                    Content & Growth
                  </h2>
                ...
                <div className="mb-8">
                  ...
                  <p className="text-xs text-text-tertiary">From £500 • 2-4 week delivery</p>
                </div>
                ...
                <div className="mb-8 flex flex-col gap-3">
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="w-full justify-center px-6 py-3 text-sm font-sans font-medium"
                  >
              ...
              <article className="relative flex flex-col rounded-3xl border-2 border-brand/30 bg-surface shadow-token-sm p-8 transition-all duration-300 hover:border-brand hover:shadow-token-lg lg:p-10">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-xs text-text-tertiary">From £750 • 3-6 week delivery</p>
                </div>
              ...
              <article className="relative flex flex-col rounded-3xl border-2 border-accent bg-surface shadow-token-sm p-8 transition-all duration-300 hover:border-accent hover:shadow-token-lg md:col-span-2 lg:p-10">
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 transform">
                  <div className="rounded-full bg-accent px-4 py-2 text-xs font-bold uppercase text-text-inverse">
                    Most Popular
                  </div>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <p className="text-xs text-text-tertiary">From £1,200 • 4-8 week delivery</p>
                </div>
