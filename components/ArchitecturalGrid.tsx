    ...
    <div className={cn("absolute inset-0 pointer-events-none", className)}>
      ...
      >
        ...
        <rect
          ...
          className="text-alira-onyx dark:text-alira-porcelain/10"
          style={{ opacity: opacityClasses[variant] }}
        />
        {variant === 'full' && (
          <g className="text-alira-onyx dark:text-alira-porcelain/15" style={{ opacity: opacityClasses[variant] * 0.7 }}>
