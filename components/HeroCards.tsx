...
import { FileText, Target, Zap, Clock } from 'lucide-react'

export default function HeroCards() {
  return (
    <section className="py-20 bg-gradient-to-br from-alira-porcelain/20 via-white to-alira-porcelain/20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <Card className="border-2 border-alira-gold/20 hover:border-alira-gold/40 transition-colors bg-white">
          ...
          <Card className="border-2 border-alira-gold/20 hover:border-alira-gold/40 transition-colors bg-white">
            <CardHeader className="text-center">
              <div className="w-12 h-12 bg-alira-gold/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Clock className="w-6 h-6 text-alira-gold" />
              </div>
              <CardTitle className="text-lg font-semibold text-alira-onyx">
                Implementation Plan
              </CardTitle>
