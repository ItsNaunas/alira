          ...
          <Reveal delay={100}>
            <div className="bg-gradient-to-r from-alira-gold/10 to-alira-porcelain/20 p-4 rounded-lg border border-alira-gold/20 mb-8">
              <div className="flex items-center justify-center gap-2 text-sm">
                <span className="text-alira-onyx dark:text-alira-porcelain/80">Most people start with</span>
                <span className="font-bold text-alira-gold">Clarity Session</span>
                <span className="text-alira-onyx dark:text-alira-porcelain/60">→</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              ...
              <Reveal delay={200}>
                <div className="bg-white dark:bg-alira-onyx/20 p-6 rounded-lg border border-alira-onyx/10 dark:border-alira-porcelain/10 hover:border-alira-gold/20 hover:shadow-lg transition-all duration-300 text-center">
                  ...
                  <h5 className="font-bold text-alira-onyx dark:text-alira-porcelain mb-2">Walk away with 1 clear next step</h5>
                  <p className="text-alira-onyx dark:text-alira-porcelain/80 mb-3 text-sm">{services[0].description}</p>
              ...
              <Reveal delay={300}>
                <div className="bg-gradient-to-br from-alira-gold/12 to-white dark:from-alira-gold/20 dark:to-alira-onyx/30 p-8 rounded-xl border-2 border-alira-gold/50 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 relative text-center">
                  ...
                  <h5 className="font-bold text-alira-onyx dark:text-alira-porcelain mb-2">Get your one-page plan + 3 priorities</h5>
                  <p className="text-alira-onyx dark:text-alira-porcelain/80 mb-3 text-sm">{services[1].description}</p>
                  <p className="text-alira-onyx dark:text-alira-porcelain/60 text-xs mb-4">Price confirmed before booking</p>
                  <CTAButton 
                    href="/contact" 
                    variant="alira"
                    className="w-full text-sm py-2"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Reveal delay={400}>
                <div className="bg-white dark:bg-alira-onyx/20 p-6 rounded-lg border border-alira-onyx/10 dark:border-alira-porcelain/10 hover:border-alira-gold/20 hover:shadow-lg transition-all duration-300 text-center">
                  ...
                  <h5 className="font-bold text-alira-onyx dark:text-alira-porcelain mb-2">Turn your idea into a real test</h5>
                  <p className="text-alira-onyx dark:text-alira-porcelain/80 mb-3 text-sm">{services[2].description}</p>
                  <p className="text-alira-onyx dark:text-alira-porcelain/60 text-xs mb-4">Price confirmed before booking</p>
                  <CTAButton 
                    href="/contact" 
                    variant="aliraOutline"
              ...
              <Reveal delay={500}>
                <div className="bg-white dark:bg-alira-onyx/20 p-6 rounded-lg border border-alira-onyx/10 dark:border-alira-porcelain/10 hover:border-alira-gold/20 hover:shadow-lg transition-all duration-300 text-center">
                  ...
                  <h5 className="font-bold text-alira-onyx dark:text-alira-porcelain mb-2">Reset your workflow in 30 days</h5>
                  <p className="text-alira-onyx dark:text-alira-porcelain/80 mb-3 text-sm">{services[3].description}</p>
                  <p className="text-alira-onyx dark:text-alira-porcelain/60 text-xs mb-4">Price confirmed before booking</p>
                  <CTAButton 
                    href="/contact" 
                    variant="aliraOutline"
              ...
              <Reveal delay={600}>
                <div className="bg-white dark:bg-alira-onyx/20 p-6 rounded-lg border border-alira-onyx/10 dark:border-alira-porcelain/10 hover:border-alira-gold/20 hover:shadow-lg transition-all duration-300 text-center">
                  ...
                  <h5 className="font-bold text-alira-onyx dark:text-alira-porcelain mb-2">Build and launch with hands-on support</h5>
                  <p className="text-alira-onyx dark:text-alira-porcelain/80 mb-3 text-sm">{services[4].description}</p>
                  <p className="text-alira-onyx dark:text-alira-porcelain/60 text-xs mb-4">Price confirmed before booking</p>
                  <CTAButton 
                    href="/contact" 
                    variant="aliraOutline"
