            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <Reveal delay={200}>
                <div className="bg-alira-porcelain/30 dark:bg-alira-onyx/20 p-8 rounded-2xl border border-alira-onyx/10 dark:border-alira-porcelain/10">
                  <h2 className="text-3xl font-bold text-alira-onyx dark:text-alira-porcelain mb-6">Send us a message</h2>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      <label htmlFor="name" className="block text-sm font-medium text-alira-onyx dark:text-alira-porcelain mb-2">
                        Name *
                      </label>
                      <Input
                        id="name"
                    ...
                    <div>
                      <label htmlFor="email" className="block text-sm font-medium text-alira-onyx dark:text-alira-porcelain mb-2">
                        Email *
                      </label>
                      <Input
                        id="email"
                    ...
                    <div>
                      <label htmlFor="message" className="block text-sm font-medium text-alira-onyx dark:text-alira-porcelain mb-2">
                        Message *
                      </label>
                      <Textarea
                        id="message"
                    ...
                    <Button
                      type="submit"
                      disabled={isSubmitting}
                      className="w-full bg-alira-onyx dark:bg-alira-porcelain hover:bg-alira-onyx/90 dark:hover:bg-alira-porcelain/90 text-white dark:text-alira-onyx py-3 px-6 rounded-lg font-medium transition-colors disabled:opacity-50"
                    >
                      {isSubmitting ? (
                        <>
