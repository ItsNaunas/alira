        ...
        <div className="container mx-auto px-6 lg:px-8">
          <Reveal>
            <div className="max-w-5xl mx-auto text-center">
              ...
              <p className="text-xl text-alira-onyx/80 leading-relaxed max-w-3xl mx-auto mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                {stats.map((stat, index) => (
                  ...
                  >
                    ...
                    <div className="text-alira-onyx/70 mb-2">{stat.label}</div>
                    <div className={`text-sm text-alira-onyx/60 transition-all duration-300 ${
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <Reveal>
                <div>
                  <h2 className="text-3xl md:text-4xl font-bold text-alira-onyx mb-6">
                    Our Mission
                  </h2>
                  <div className="w-12 h-px bg-alira-gold mb-6"></div>
                  <p className="text-lg text-alira-onyx/80 leading-relaxed mb-6">
          ...
          <div className="container mx-auto px-6 lg:px-8 relative z-10">
            ...
            <div className="mt-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <Reveal delay={700}>
                  <div 
                    className={`bg-white/80 backdrop-blur-sm p-10 rounded-2xl border transition-all duration-500 text-center group relative overflow-hidden cursor-pointer ${
                      activeTeamMember === 0 
            ...
            <div className="mt-20">
              <Reveal delay={1000}>
                <div className="text-center mb-12">
                  <h3 className="text-3xl font-bold text-alira-onyx mb-4">How We Work Together</h3>
                  <p className="text-lg text-alira-onyx/70 max-w-2xl mx-auto">
              ...
              <div className="max-w-4xl mx-auto">
                <Reveal delay={1100}>
                  <div className="bg-white/60 backdrop-blur-sm p-8 rounded-2xl border border-alira-onyx/10">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                      <div>
                        <h4 className="text-lg font-semibold text-alira-onyx mb-3">Strategy First</h4>
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-alira-onyx mb-3">Marketing Integration</h4>
                        <p className="text-alira-onyx/70 text-sm">
                          Your message and reach are built into the plan from day one, not added as an afterthought.
                        </p>
                      </div>
                      <div>
                        <h4 className="text-lg font-semibold text-alira-onyx mb-3">Systems That Scale</h4>
                        <p className="text-alira-onyx/70 text-sm">
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Reveal delay={200}>
                <div className="bg-white p-6 rounded-xl border border-alira-onyx/10 text-center hover:border-alira-gold/30 hover:shadow-lg transition-all duration-300 group cursor-pointer">
                  ...
                  <h3 className="text-lg font-semibold text-alira-onyx mb-3">Company Registration</h3>
                  <p className="text-alira-onyx/70 text-sm">
              ...
              <Reveal delay={300}>
                <div className="bg-white p-6 rounded-xl border border-alira-onyx/10 text-center hover:border-alira-gold/30 hover:shadow-lg transition-all duration-300 group cursor-pointer">
                  ...
                  <h3 className="text-lg font-semibold text-alira-onyx mb-3">Privacy & Security</h3>
                  <p className="text-alira-onyx/70 text-sm">
              ...
              <Reveal delay={400}>
                <div className="bg-white p-6 rounded-xl border border-alira-onyx/10 text-center hover:border-alira-gold/30 hover:shadow-lg transition-all duration-300 group cursor-pointer">
                  ...
                  <h3 className="text-lg font-semibold text-alira-onyx mb-3">Our Commitment</h3>
                  <p className="text-alira-onyx/70 text-sm">
