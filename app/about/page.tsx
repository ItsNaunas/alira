  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <Reveal>
            <div className="max-w-5xl mx-auto text-center">
              ...
              <p className="text-xl text-alira-primary/80 dark:text-alira-white/80 leading-relaxed max-w-3xl mx-auto mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                {stats.map((stat, index) => (
                  <div 
                    ...
                    className={`text-center p-6 rounded-xl cursor-pointer transition-all duration-300 ${
                      activeStat === index 
                        ...
                        : 'hover:bg-alira-gold/5 hover:border border-alira-primary/10'
                    }`}
                  ...
                  >
                    ...
                    <div className="text-alira-primary/70 dark:text-alira-white/70 mb-2">{stat.label}</div>
                    <div className={`text-sm text-alira-primary/60 dark:text-alira-white/60 transition-all duration-300 ${
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <Reveal>
                <div>
                  ...
                  <p className="text-lg text-alira-primary/80 dark:text-alira-white/80 leading-relaxed mb-6">
                  ...
                  <p className="text-lg text-alira-primary/80 dark:text-alira-white/80 leading-relaxed">
      ...
      {/* Meet the Team Section */}
        <section className="py-24 bg-gradient-to-br from-alira-white/30 via-white to-alira-white/20 dark:from-alira-primary/30 dark:via-alira-primary dark:to-alira-primary/20 relative overflow-hidden" aria-labelledby="team-heading">
          {/* Subtle background pattern */}
          <div className="absolute inset-0 pointer-events-none opacity-[0.02]">
            <div className="absolute inset-0" style={{
              backgroundImage: `linear-gradient(to right, #0B1D51 1px, transparent 1px),
                               linear-gradient(to bottom, #0B1D51 1px, transparent 1px)`,
          ...
          <div className="container mx-auto px-6 lg:px-8 relative z-10">
            <div className="max-w-6xl mx-auto">
              <Reveal>
                <div className="text-center mb-20">
                  <h2 id="team-heading" className="text-4xl md:text-5xl font-serif font-normal text-alira-primary dark:text-alira-white mb-6">
                    Meet the Team
                  </h2>
                  <div className="w-16 h-px bg-alira-gold mx-auto mb-8"></div>
                </div>
            ...
            <div className="mb-16">
              <Reveal delay={100}>
                <div className="text-center mb-12">
                  <h3 className="text-3xl font-serif font-normal text-alira-primary dark:text-alira-white mb-4">Our Founder</h3>
                  <p className="text-lg text-alira-primary/70 dark:text-alira-white/70 max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-2xl text-alira-primary dark:text-alira-white font-serif italic leading-relaxed pl-6">
                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-alira-primary/80 dark:text-alira-white/80 font-sans font-light">10+ years in project management</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-2 h-2 bg-alira-gold rounded-full"></div>
                      <span className="text-alira-primary/80 dark:text-alira-white/80 font-sans font-light">Experience leading teams across multiple industries</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-2 h-2 bg-alira-gold rounded-full"></div>
                      <span className="text-alira-primary/80 dark:text-alira-white/80 font-sans font-light">Delivered projects that saved organisations time and money</span>
                    </div>
                  </div>
            ...
            <div className="mt-20">
              <Reveal delay={600}>
                <div className="text-center mb-12">
                  <h3 className="text-3xl font-serif font-normal text-alira-primary dark:text-alira-white mb-4">Our Team Capabilities</h3>
                  <p className="text-lg text-alira-primary/70 dark:text-alira-white/70 max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <Reveal delay={700}>
                  <div 
                    className={`bg-white/80 dark:bg-alira-primary/80 backdrop-blur-sm p-10 rounded-2xl border transition-all duration-500 text-center group relative overflow-hidden cursor-pointer ${
                      activeTeamMember === 0 
                        ? 'border-alira-gold/50 shadow-2xl bg-alira-gold/10 scale-105' 
                        : 'border-alira-primary/10 hover:border-alira-gold/30 hover:shadow-2xl hover:bg-alira-gold/5'
                    }`}
                  ...
                  >
                    ...
                    <h4 className="text-2xl font-serif font-normal text-alira-primary dark:text-alira-white mb-4">The Strategist</h4>
                    <p className="text-alira-primary/80 dark:text-alira-white/80 leading-relaxed mb-6">
                      Sees the bigger picture and turns ideas into steps you can act on.
                    </p>
                    <div className="text-sm text-alira-primary/70 dark:text-alira-white/70 space-y-3 text-left">
                      <p><span className="font-light text-alira-primary dark:text-alira-white">Runs clarity sessions and workshops</span> to define goals</p>
                      <p><span className="font-light text-alira-primary dark:text-alira-white">Creates 90-day and 1-year growth roadmaps</span> for clear direction</p>
                      <p><span className="font-light text-alira-primary dark:text-alira-white">Breaks complex challenges</span> into simple, actionable projects</p>
                    </div>
                    ...
                    <div className={`mt-6 transition-all duration-300 ${
                      ...
                      <button className="text-alira-gold text-sm font-sans font-light hover:text-alira-primary dark:text-alira-white dark:hover:text-alira-white transition-colors">
                        See How We Work →
                      </button>
                    </div>
                  </div>
                ...
                <Reveal delay={800}>
                  ...
                  >
                    ...
                    <h4 className="text-2xl font-serif font-normal text-alira-primary dark:text-alira-white mb-4">The Marketing Lead</h4>
                    <p className="text-alira-primary/80 dark:text-alira-white/80 leading-relaxed mb-6">
                      Knows how to make your brand impossible to ignore.
                    </p>
                    <div className="text-sm text-alira-primary/70 dark:text-alira-white/70 space-y-3 text-left">
                      <p><span className="font-light text-alira-primary dark:text-alira-white">Improves your social media content</span> and campaigns for better engagement</p>
                      <p><span className="font-light text-alira-primary dark:text-alira-white">Builds content calendars</span> to grow visibility and reach</p>
                      <p><span className="font-light text-alira-primary dark:text-alira-white">Helps you reach the right customers</span> with clear, compelling messaging</p>
                    </div>
                ...
                <Reveal delay={900}>
                  ...
                  >
                    ...
                    <h4 className="text-2xl font-serif font-normal text-alira-primary dark:text-alira-white mb-4">The Systems Engineer</h4>
                    <p className="text-alira-primary/80 dark:text-alira-white/80 leading-relaxed mb-6">
                      Builds the tools and processes that unlock growth.
                    </p>
                    <div className="text-sm text-alira-primary/70 dark:text-alira-white/70 space-y-3 text-left">
                      <p><span className="font-light text-alira-primary dark:text-alira-white">Designs and launches websites</span> and online platforms that convert</p>
                      <p><span className="font-light text-alira-primary dark:text-alira-white">Integrates AI into daily workflows</span> to boost efficiency and insights</p>
                      <p><span className="font-light text-alira-primary dark:text-alira-white">Automates repetitive tasks</span> to free up time and reduce chaos</p>
                    </div>
            ...
            <div className="mt-20">
              <Reveal delay={1000}>
                <div className="text-center mb-12">
                  <h3 className="text-3xl font-serif font-normal text-alira-primary dark:text-alira-white mb-4">How We Work Together</h3>
                  <p className="text-lg text-alira-primary/70 dark:text-alira-white/70 max-w-2xl mx-auto">
              ...
              <div className="max-w-4xl mx-auto">
                <Reveal delay={1100}>
                  <div className="bg-white/60 dark:bg-alira-primary/60 backdrop-blur-sm p-8 rounded-2xl border border-alira-primary/10 dark:border-alira-white/10">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                      <div>
                        <h4 className="text-lg font-serif font-normal text-alira-primary dark:text-alira-white mb-3">Strategy First</h4>
                      ...
                      <div>
                        <h4 className="text-lg font-serif font-normal text-alira-primary dark:text-alira-white mb-3">Marketing Integration</h4>
                        <p className="text-alira-primary/70 dark:text-alira-white/70 text-sm">
                          Your message and reach are built into the plan from day one, not added as an afterthought.
                        </p>
                      </div>
                      <div>
                        <h4 className="text-lg font-serif font-normal text-alira-primary dark:text-alira-white mb-3">Systems That Scale</h4>
                        <p className="text-alira-primary/70 dark:text-alira-white/70 text-sm">
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <Reveal>
            <div className="text-center mb-16">
              ...
              <div className="w-16 h-px bg-alira-gold mx-auto mb-8"></div>
              <p className="text-xl text-alira-primary/70 dark:text-alira-white/70 max-w-2xl mx-auto">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <Reveal delay={200}>
                <div 
                  className={`bg-white dark:bg-alira-primary/20 p-8 rounded-xl border transition-all duration-300 cursor-pointer ${
                    hoveredPrinciple === 0 
                      ? 'border-alira-gold/30 shadow-xl bg-alira-gold/5 scale-105' 
                      : 'border-alira-primary/10 hover:border-alira-gold/20 hover:shadow-lg'
                  }`}
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-serif font-normal text-alira-primary dark:text-alira-white mb-3">Clarity over complexity</h3>
              ...
              <Reveal delay={300}>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-serif font-normal text-alira-primary dark:text-alira-white mb-3">Small tests beat big theories</h3>
                      <p className="text-alira-primary/80 dark:text-alira-white/80 leading-relaxed">
              ...
              <Reveal delay={400}>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-serif font-normal text-alira-primary dark:text-alira-white mb-3">Focus creates movement</h3>
                      <p className="text-alira-primary/80 dark:text-alira-white/80 leading-relaxed">
              ...
              <Reveal delay={500}>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-serif font-normal text-alira-primary dark:text-alira-white mb-3">Systems should serve you</h3>
                      <p className="text-alira-primary/80 dark:text-alira-white/80 leading-relaxed">
      ...
      <section className="py-24 bg-gradient-to-r from-alira-white/20 via-white to-alira-white/20 dark:from-alira-primary/20 dark:via-alira-primary dark:to-alira-primary/20">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <Reveal>
              <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Reveal delay={200}>
                <div className="bg-white dark:bg-alira-primary/20 p-6 rounded-xl border border-alira-primary/10 dark:border-alira-white/10 text-center hover:border-alira-gold/30 hover:shadow-lg transition-all duration-300 group cursor-pointer">
                  ...
                  <h3 className="text-lg font-serif font-normal text-alira-primary dark:text-alira-white mb-3">Company Registration</h3>
                  <p className="text-alira-primary/70 dark:text-alira-white/70 text-sm">
              ...
              <Reveal delay={300}>
                <div className="bg-white dark:bg-alira-primary/20 p-6 rounded-xl border border-alira-primary/10 dark:border-alira-white/10 text-center hover:border-alira-gold/30 hover:shadow-lg transition-all duration-300 group cursor-pointer">
                  ...
                  <h3 className="text-lg font-serif font-normal text-alira-primary dark:text-alira-white mb-3">Privacy & Security</h3>
                  <p className="text-alira-primary/70 dark:text-alira-white/70 text-sm">
              ...
              <Reveal delay={400}>
                <div className="bg-white dark:bg-alira-primary/20 p-6 rounded-xl border border-alira-primary/10 dark:border-alira-white/10 text-center hover:border-alira-gold/30 hover:shadow-lg transition-all duration-300 group cursor-pointer">
                  ...
                  <h3 className="text-lg font-serif font-normal text-alira-primary dark:text-alira-white mb-3">Our Commitment</h3>
                  <p className="text-alira-primary/70 dark:text-alira-white/70 text-sm">
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-br from-alira-primary to-alira-primary/90 dark:from-alira-white dark:to-alira-white/90">
        <div className="container mx-auto px-6 lg:px-8">
          <Reveal>
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-4xl md:text-5xl font-serif font-normal text-white dark:text-alira-primary mb-6">
                Ready to work with us?
              </h2>
              <p className="text-xl text-white/80 dark:text-alira-primary/80 mb-8 leading-relaxed">
