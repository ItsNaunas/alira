      ...
      <section className="py-20 bg-white dark:bg-alira-onyx">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <Reveal delay={200}>
              <div className="bg-white dark:bg-alira-onyx/80 rounded-2xl p-8 lg:p-12 border border-alira-onyx/10 shadow-xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {keyAchievements.map((achievement, index) => (
                    <div key={index} className="flex items-start space-x-3">
                      ...
                      <p className="text-alira-onyx dark:text-alira-porcelain/80 leading-relaxed">
                        {achievement}
                      </p>
                    </div>
                  ))}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {clientTestimonials.map((testimonial, index) => (
                <Reveal key={index} delay={index * 150}>
                  <div className="bg-white dark:bg-alira-onyx/80 rounded-2xl p-8 border border-alira-onyx/10 hover:border-alira-gold/20 hover:shadow-xl transition-all duration-300 relative">
                    {/* Quote icon */}
                    ...
                    {/* Quote */}
                    <blockquote className="text-alira-onyx dark:text-alira-porcelain/80 italic mb-6 leading-relaxed">
                      "{testimonial.quote}"
                    </blockquote>
