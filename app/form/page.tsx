          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Reveal>
              <div className="mb-8">
                <Link
                  href="/"
                  className="inline-flex items-center text-alira-onyx/70 dark:text-alira-porcelain/70 hover:text-alira-onyx dark:hover:text-alira-porcelain transition-colors"
                >
            ...
            {/* Headline */}
            <Reveal delay={200}>
              <h1 id="form-heading" className="text-5xl md:text-7xl font-bold text-alira-onyx dark:text-alira-porcelain leading-[0.95] tracking-tight mb-8">
