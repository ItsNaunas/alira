...
export default function WhatYouGetPage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="py-24 bg-gradient-to-br from-alira-gold/5 via-white to-alira-gold/10">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <Reveal>
              <div className="mb-12">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-normal text-alira-primary leading-tight mb-6">
                  Your Complete Business Plan
                </h1>
                <div className="w-20 h-px bg-alira-gold mx-auto mb-8"></div>
                <p className="text-xl md:text-2xl text-alira-primary/70 max-w-3xl mx-auto leading-relaxed">
      ...
      {/* Main Benefits */}
      <section className="py-20 bg-gradient-to-br from-alira-gold/3 via-alira-gold/5 to-alira-gold/8">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <Reveal>
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl font-serif font-normal text-alira-primary mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 mb-16">
              {mainBenefits.map(({ icon: Icon, title, desc }, index) => (
                <Reveal key={title} delay={index * 100}>
                  <article className="group rounded-2xl border border-alira-primary/5 bg-white p-8 lg:p-10 transition-all duration-300 hover:-translate-y-1 hover:border-alira-gold/20 hover:shadow-xl">
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <h3 className="text-lg font-serif font-normal text-alira-primary mb-3 leading-tight">
                          {title}
                        </h3>
                        <p className="text-alira-primary/70 leading-relaxed">
                          {desc}
                        </p>
                      </div>
                    </div>
            ...
            {/* Quick Stats */}
            <Reveal delay={400}>
              <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-12 text-center bg-alira-white/20 rounded-2xl p-8">
                <div className="flex flex-col items-center">
                  <span className="text-2xl font-serif font-normal text-alira-primary">Ready in minutes</span>
                  <span className="text-sm text-alira-primary/60 mt-1">delivered instantly</span>
                </div>
                <div className="hidden md:block w-px h-8 bg-alira-primary/20"></div>
                <div className="flex flex-col items-center">
                  <span className="text-2xl font-serif font-normal text-alira-primary">100% custom</span>
                  <span className="text-sm text-alira-primary/60 mt-1">tailored to your business</span>
                </div>
                <div className="hidden md:block w-px h-8 bg-alira-primary/20"></div>
                <div className="flex flex-col items-center">
                  <span className="text-2xl font-serif font-normal text-alira-primary">Ready to use</span>
                  <span className="text-sm text-alira-primary/60 mt-1">implement immediately</span>
                </div>
              </div>
            </Reveal>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <Reveal>
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-alira-primary/70 max-w-3xl mx-auto">
              ...
              {detailedFeatures.map((feature, index) => {
                ...
                return (
                  <Reveal key={index} delay={index * 150}>
                    <div className="bg-white rounded-2xl p-8 border border-alira-primary/10 hover:border-alira-gold/20 hover:shadow-xl transition-all duration-300">
                      <div className="flex items-center mb-6">
                        ...
                        <div>
                          <h3 className="text-xl font-serif font-normal text-alira-primary">
                            {feature.title}
                          </h3>
                        </div>
                      </div>
                      
                      <p className="text-alira-primary/80 mb-6 leading-relaxed">
                        {feature.description}
                      </p>
                      ...
                      <ul className="space-y-3">
                        {feature.details.map((detail, detailIndex) => (
                          <li key={detailIndex} className="flex items-start space-x-3">
                            ...
                            <span className="text-alira-primary/70 text-sm">
                              {detail}
                            </span>
                          </li>
                        ))}
