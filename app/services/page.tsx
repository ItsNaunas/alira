                ...
                <div className="bg-alira-onyx/5 p-8 rounded-lg border border-alira-onyx/10">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start space-x-4">
                      ...
                      <span className="copy">No generic templates or one-size-fits-all approaches</span>
                    </li>
                    <li className="flex items-start space-x-4">
                      <span className="text-alira-gold font-bold text-lg">•</span>
                      <span className="copy">Proven frameworks adapted to your specific context</span>
                    </li>
                    <li className="flex items-start space-x-4">
                      <span className="text-alira-gold font-bold text-lg">•</span>
                      <span className="copy">Immediate value through structured thinking and planning</span>
                    </li>
                    <li className="flex items-start space-x-4">
                      <span className="text-alira-gold font-bold text-lg">•</span>
                      <span className="copy">Clear deliverables and measurable outcomes</span>
                    </li>
                  </ul>
                </div>
              </div>
